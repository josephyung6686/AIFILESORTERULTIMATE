...
> **Superseded as the current verdict** by [`20-p1-p5-recheck.md`](20-p1-p5-recheck.md) (2026-08-21 ~02:00). This page is the break list that pass closed. Do not treat the “cannot store a run” headline as live.
