...
| **I4** | Analysis tiers are still unnamed | §3.4 puts analysis tier in the cache key. P2's `version_tuple.analysis_tier` has nowhere to draw from. P4, P5, and P6 all flag this. The skeleton can fake a constant; v1 cannot. | P5 OQ3 · P4 OQ1 · P6 OQ1 |
