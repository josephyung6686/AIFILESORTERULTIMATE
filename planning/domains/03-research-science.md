...
| 14 | `res.lab-notebook` | Lab notebooks and experiment records | design | none | project → experiment → entry date | no |
...
Counts by provenance: **design** 5, **inference** 11, **proposal** 24. Marked `potentially sensitive`: **16**. Open questions: **17**.
...
**provenance**: `design` — §3.15: 'academic coursework, college applications, research and lab work, career and recruiting, photos and captures, and code projects' — 'research and lab work' names lab work as a launch domain. §3.11: 'Research files may use project, stage, artifact type, lab, and venue.' gives it the `lab` field.
